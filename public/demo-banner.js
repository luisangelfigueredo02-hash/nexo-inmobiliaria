...
(function () {
  function showDemoBanner() {
    ...
    b.innerHTML = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" aria-hidden="true"><path d="M10 2v6L4.5 18a2 2 0 0 0 1.8 3h11.4a2 2 0 0 0 1.8-3L14 8V2"/><path d="M8.5 2h7"/><path d="M7 15h10"/></svg>' +
      "<span><strong>Modo demostraci\u00f3n</strong> \u2014 el inventario mostrado es de ejemplo.</span>";
    // Estilos: #demo-banner en variables.css (sistema de diseño).
