...
__name(rejectResponse, "rejectResponse");
...
__name(buildSessionClearCookie, "buildSessionClearCookie");
...
__name(parseSessionTokens, "parseSessionTokens");
...
__name(getAuthenticatedSession, "getAuthenticatedSession");
...
__name(isStateChangingAllowed, "isStateChangingAllowed");

// src/auth/authorization/permissions.js
...
__name(isKnownPermission, "isKnownPermission");

// src/auth/authorization/roles.js
...
// src/auth/authorization/matrix.js
...
// src/auth/authorization/actor.js
...
__name(legacyAdminActor, "legacyAdminActor");

// src/auth/authorization/resource.js
...
__name(classifyListingIdentifier, "classifyListingIdentifier");
...
__name(resolveListing, "resolveListing");

// src/auth/authorization/ownership.js
...
__name(getListingRelationship, "getListingRelationship");

// src/auth/authorization/authorize.js
...
__name(evaluateUserAction, "evaluateUserAction");
...
__name(evaluateRoleGrants, "evaluateRoleGrants");
...
__name(evaluatePublic, "evaluatePublic");
...
// src/auth/authorization/serialize.js
...
// src/auth/authorization/audit.js
...
__name(userAgentBounded, "userAgentBounded");
...
__name(emitAuthorizationAudit, "emitAuthorizationAudit");

// src/auth/authorization/index.js
...
__name(denyResponse, "denyResponse");
...
__name(listingLookup, "listingLookup");
...
__name(validatePropertyInput, "validatePropertyInput");
...
__name(normalizeCoord, "normalizeCoord");
...
var worker_default = {
  ...
  async route(request, env, ctx) {
    ...
    const isAdmin = /* @__PURE__ */ __name((req) => {
    ...
    const authorizeAdminPlane = /* @__PURE__ */ __name(async (action) => {
    ...
    const normalizeImages = /* @__PURE__ */ __name((imagesStr) => {
      if (!imagesStr) return [];
      try {
